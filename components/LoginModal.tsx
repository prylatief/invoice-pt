    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white w-full max-w-md p-8 rounded-2xl shadow-2xl relative animate-in fade-in zoom-in duration-200">
        ...
        <button
          ...
          disabled={loading || googleLoading}
          className="w-full bg-white hover:bg-gray-50 text-gray-700 py-2.5 rounded-lg font-medium transition-all flex items-center justify-center gap-3 border border-gray-300 shadow-sm disabled:opacity-70"
        >
          {googleLoading ? (
            <Loader2 className="animate-spin" size={20} />
          ) : (
